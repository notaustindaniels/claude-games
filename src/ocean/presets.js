...
export const PRESETS = {
  blackflag: {
    // spectrum
    wind: 8.5, fetch: 160e3, gamma: 2.4, dirSpread: 8, windDir: 0.42,
    chop: 1.15, ampMul: 1.0, seed: 1337,
    // optics
    ...
    // sun / sky
    sunAzimuth: 0.0, sunElevation: 48 * Math.PI / 180,
    sunColor: [1.0, 0.94, 0.82], sunIntensity: 1.35,
  ...
  storm: {
    ...
    chop: 1.5, ampMul: 0.92, seed: 4242,
    ...
    roughBase: 0.075,
    foam: { tau: 6.0, jThr: 0.80, inj: 2.4, ambient: 0.09, lace: 1.0 },
